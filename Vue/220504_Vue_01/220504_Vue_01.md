...
- SSR & CSR
  ...
  - 단, 특정 요서(좋아요/팔로우)만 JS(AJAX & DOM조작)를 활용 (CSR)
...
- 'this' keyword in vue.js
  ...
  <img src="220504_Vue_01.assets/image-20220504124218663.png" alt="image-20220504124218663" style="zoom:67%;" />
...
- v-text
  ...
  ![image-20220504125059854](220504_Vue_01.assets/image-20220504125059854.png)
...
- v-show
  ...
  ![image-20220504125331128](220504_Vue_01.assets/image-20220504125331128.png)
...
- v-if , v-else-if , v-else
  ...
  - 엘리먼트 및 표현된 directive는 토글하는 동안 삭제되고 다시 작성됨
   ...
   ![image-20220504125455831](220504_Vue_01.assets/image-20220504125455831.png)
...
- v-for
  ...
  ![image-20220504130047925](220504_Vue_01.assets/image-20220504130047925.png)
...
- Options/Assets - 'filter'
  ...
  - 필터는 자바스크립트 표현ㅅㄱ 마지막에 '|'(파이프)와 함께 추가되어야 함
  - 이어서 사용(chaining) 가능
...
- Lifecycle Hooks 예시
  ...
  <img src="220504_Vue_01.assets/image-20220504132235684.png" alt="image-20220504132235684" style="zoom:67%;" />

  - created를 사용해 애플리케이션의 초기 데이터를 API 요청을 통해 불러올 수 있음

  ![image-20220504132318166](220504_Vue_01.assets/image-20220504132318166.png)
